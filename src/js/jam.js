...
function asasas(e) {
    console.log(e);
    window.removeEventListener("scroll", asasas);
    window.removeEventListener("mousemove", asasas);
    window.removeEventListener("resize", asasas);
}

window.addEventListener("scroll", asasas );
window.addEventListener("mousemove", asasas );
window.addEventListener("resize", asasas );
*/
